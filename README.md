...
| Qwen4 Exp (Text) | `liger_kernel.transformers.apply_liger_kernel_to_qwen4_exp` | RMSNorm, SwiGLU, PLE/Engram, HyperConnection, CrossEntropyLoss, FusedLinearCrossEntropy |
